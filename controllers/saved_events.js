...
router.post('/:itinerary_id/events', (req, res) => {
...
router.get('/:itinerary_id/events', (req, res) => {
...
router.patch('/:itinerary_id/events/:event_id', (req, res) => {
...
router.delete('/:itinerary_id/events/:event_id', (req, res) => {
